...
presentation checks, and figure updates are in place. Use the implementation
plan for the current sequencing and `architecture.md` for the stable ownership
